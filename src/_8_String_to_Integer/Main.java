...
public class Main {
    public static void main(String[] args) {
         ...
         * he rest of the string is ignored.
        ...
        String str = "  with words  214557483 with words";
    ...
    public static int myAtoi(String s) {
        ...
        long parsedLong = Long.parseLong(newString);
        if (parsedLong > Integer.MAX_VALUE){
            result = Integer.MAX_VALUE;
        } else if (parsedLong < Integer.MIN_VALUE){
